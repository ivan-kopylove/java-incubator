...
class ChildEntity14
{
    ...
    private kopylove.hibernate.ParentEntity parent;
    ...
    public kopylove.hibernate.ParentEntity getParent()
    {
        return parent;
    }

    public void setParent(kopylove.hibernate.ParentEntity parent)
    {
        this.parent = parent;
    }
}
