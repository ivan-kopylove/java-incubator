...
- in form of MVP: the examples of minimal permutations of components required to achieve some goal isolated from a production project so that in the production project where everything is mixed I can easily recognize it; 
